...
public class LocationEventConverter {
    ...
    public static PebbleDictionary Convert(NewLocationEvent event,boolean serviceRunning,boolean debug, boolean liveTrackingEnabled, int refreshInterval,int heartRate) {
